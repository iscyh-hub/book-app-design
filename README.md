...
> 本仓库为产品/设计作品集，包含 PRD、Axure 原型、业务流程图、信息架构图、UI 页面切图及设计迭代稿。
...
> 面试讲述主线：**需求分析 → 产品架构设计 → 原型设计 → 研发跟进 → 测试上线**
...
- 与开发团队进行需求评审，拆解技术实现方案（前端、后端、数据库、接口）；
- 跟进开发进度，处理需求变更与优先级调整；
...
| 书城首页 | 图书详情 | 电子书阅读 | 听书 |
|----------|----------|------------|------|
| ![商城](商城.png) | ![售卖详情](页面切图/售卖详情.jpg) | ![正文](页面切图/正文.jpg) | ![听书](页面切图/听书.jpg) |

### 6.2 论坛与我的

| 论坛首页 | 论坛发布 | 我的 | 个人资料 |
|----------|----------|------|----------|
| ![论坛首页](页面切图/论坛首页.jpg) | ![论坛发布](页面切图/论坛发布.jpg) | ![我的](页面切图/我的.jpg) | ![个人资料](页面切图/个人资料.jpg) |

### 6.3 购物流程

| 商城 | 购物车 | 结算 | 支付成功 |
|------|--------|------|----------|
| ![商城](页面切图/商城.jpg) | ![购物车](页面切图/购物车.jpg) | ![结算](页面切图/结算.jpg) | ![支付成功](页面切图/支付成功.jpg) |
...
1. **开场**：介绍「汇读」产品定位与目标用户；
2. **需求分析**：展示用户画像、竞品分析、需求拆解过程；
3. **架构设计**：讲解信息架构图与功能架构图，说明四大模块如何协同；
4. **流程设计**：挑选 1–2 个核心流程（如商城购书、阅读听书）详细展开；
5. **原型与视觉**：展示 Axure 原型、页面切图、Logo 迭代过程；
6. **研发协同**：说明 PRD 结构、需求评审、开发跟进、异常场景覆盖；
7. **测试上线**：说明测试用例设计、用户反馈收集、运营配合；
8. **复盘**：总结项目亮点与可优化方向，体现产品思维与迭代意识。
